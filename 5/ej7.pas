...
superen los 64 Kb, pensar en utilizar un vector de punteros a palabras.
...
begin
    writeln('La variable punteros ocupa ',SizeOf(punteros),' bytes');
    ...
    //Se debería crear un módulo para hacer dispose de cada puntero del arreglo.
end.
